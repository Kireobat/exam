<script lang="ts">
  ...
  async function register() {
    if (!firstname || !lastname || !password || !confirmPassword) {
      ...
      alert.description =
        "You need to fill in all fields to register an account";
      return;
    }
    ...
    <div class="flex justify-center">
      <div class="w-96 flex flex-col mx-6">
        <div class="flex gap-2">
          ...
          <h2 class="font-inter">Register an account</h2>
        </div>
        <div class="my-4">
          <Input name="input" bind:value={firstname} class="font-inter">
            <Input.Label slot="label" class="font-inter">Firstname</Input.Label>
          </Input>
          <Input name="input" bind:value={lastname} class="font-inter">
            <Input.Label slot="label" class="font-inter">Lastname</Input.Label>
          </Input>
          <Input
            type="password"
            name="input"
          ...
          >
            <Input.Leading slot="leading" data={key} />
            <Input.Label slot="label" class="font-inter"
